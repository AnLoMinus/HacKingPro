...
# Copyright (C) 2013 CybernetiX-S3C
#
...
__author__  = 'John Modica'
__email__   = 'CybernetiX.S3C@gmail.com'
__url__     = 'https://CybernetiX-S3C.github.io/'
__git__     = 'https://github.com/CybernetiX-S3C/predator'
__version__ = '1.4-beta'
__license__ = 'GPLv2'
__banner__  = 'Predator v%s (%s)' % (__version__, __git__)
...
Predator is a multi-purpose brute-forcer, with a modular design and a flexible usage.
...
The name "Predator" comes from http://www.youtube.com/watch?v=xoBkBvnTTjo
...
* Shortcuts (optional)
ln -s path/to/Predator.py /usr/bin/ftp_login
ln -s path/to/Predator.py /usr/bin/http_fuzz
so on ...
...
* Read carefully the following examples to get a good understanding of how Predator works.
{{{ FTP
...
def build_logdir(opt_dir, opt_auto):
    if opt_auto:
      return create_time_dir(opt_dir or '/tmp/Predator', opt_auto)
    elif opt_dir:
...
'''
    ...
    log_grp.add_option('-L', dest='auto_log', metavar='SFX', help="automatically save into DIR/yyyy-mm-dd/hh:mm:ss_SFX (DIR defaults to '/tmp/Predator')")
...
if __name__ == '__main__':
  ...
  def show_usage():
    print(__banner__)
    print('''Usage: Predator.py module --help
