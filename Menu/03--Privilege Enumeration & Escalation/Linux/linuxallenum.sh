...
while true; do
	echo " "
	echo "  ${cInfo}  ACTIVE DIRECTORY ${ORANGE}"
	echo -ne " 20. skelsec/jackdaw\t\t\t\t\t139. DanMcInerney/icebreaker\n"
	echo " "
	echo "  ${cInfo}  ANTIFORENSICS - STEGANOGRAPHY ${ORANGE}"
	echo -ne " 166. KuroLabs/stegcloak\n"
	echo " "
	echo "  ${cInfo}  AWS ${ORANGE}"
	echo -ne " 231. smaranchand/bucky\n"
	echo " "
	echo "  ${cInfo}  CRACK ${ORANGE}"
	...
	echo " "
	echo "  ${cInfo}  DNS ${ORANGE}"
	echo -ne " 33. m57/dnsteal\n"
	echo " "
	echo "  ${cInfo}  DOCKER ${ORANGE}"
	...
	echo " "
	echo "  ${cInfo}  DUMPING - EXTRACTING - EXFILTRATING ${ORANGE}"
	...
	echo " "
	echo "  ${cInfo}  SMB ${ORANGE}"
	echo -ne " 209. deepsecurity-pe/GoGhost\n"
	echo " "
	echo "  ${cInfo}  TUNNELING ${ORANGE}"
	...
	echo " "
	echo "  ${cInfo}  UPNP ${ORANGE}"
	echo -ne " 130. tenable/upnp_info\n"
	echo " "
	echo "  ${cInfo}  UTILITIES ${ORANGE}"
	...
	echo " "
	echo "  ${cInfo}  WINRM ${ORANGE}"
	echo -ne " 132. Alamot/code-snippets/winrm/\n"
	echo " "
	echo "  ${cInfo}  OTHERS ${ORANGE}"
