...
given URL. It combines the outputs of other known tools into a single one.
    ...
    - ## [SUB-Z](https://github.com/j1t3sh/SUB-Z): A Complete SubDomain Enumeration Tool
        ...
        > ![]()  <br>
        > ![](https://github.com/j1t3sh/SUB-Z/raw/master/Assets/3.gif)  <br>
        > ### **For Finding only Live SubDomains. Use :** `-live`
            python3 Sub-Z.py -d example.com -live  <br>
        > ![]()  <br>
        > ![](https://github.com/j1t3sh/SUB-Z/raw/master/Assets/4.gif)  <br>
        ...
        > ![]()  <br>
        > ![](https://github.com/j1t3sh/SUB-Z/raw/master/Assets/5.gif)  <br>
